...
description: "Complete reference for JSON Canvas node types — text, file, link, and group — with all required and optional attributes, JSON examples, and layout guidelines."
---
